...
export default function ScrollProgress() {
    ...
    return (
        <progress 
            ...
            max={1}
            className="fixed top-0 left-0 w-full h-0.5 z-50 appearance-none [&::-webkit-progress-bar]:bg-transparent [&::-webkit-progress-value]:bg-main [&::-webkit-progress-value]:opacity-60 [&::-moz-progress-bar]:bg-main [&::-moz-progress-bar]:opacity-60"
