...
export default function NavbarControls({ currentPath, initialLocale }: NavbarControlsProps = {}) {
    ...
    const [currentLang, setCurrentLang] = useState<Language>(initialLocale || 'en');
            ...
            <DropdownButton
                ...
                >
                    <div className="flex items-center gap-2 w-full">
                        ...
                        />
                        <span className="hidden @6xl:block font-grotesk text-sm pt-0.5 font-semibold text-main group-hover:text-secondary truncate uppercase">
                            {currentTheme.name}
                        </span>
                    </div>
                </DropdownButton>
            ...
            <DropdownButton
                ...
                >
                    <div className="flex items-center gap-2">
                        ...
                        <span className="hidden @6xl:block font-grotesk text-sm pt-0.5 font-semibold text-main group-hover:text-secondary uppercase">{getModeName(currentMode)}</span>
                    </div>
                </DropdownButton>
        );
    };
    ...
    const renderLanguageControls = () => {
        ...
        return (
            ...
            >
                <div className="flex items-center gap-2">
                    <span className="font-grotesk text-sm pt-0.5 font-semibold text-main group-hover:text-secondary uppercase">
