...
export default function ProjectCardReact({
  ...
  const transformStyle = isMounted && hasPointer && hasHover
    ? {
        transformStyle: 'preserve-3d' as const,
        transformOrigin: 'right center',
        transform: shouldTransform 
          ? 'rotateY(0deg) translateZ(5px) translateY(2px)'
          : 'rotateY(-8deg) translateZ(15px) translateY(-5px)',
  ...
  const containerStyle = isMounted && hasPointer && hasHover
    ? { perspective: '1000px' }
    : {};
        ...
        >
          ...
          >
            ...
            <div className="px-4 py-2">
              <h3 
                className="font-sans text-2xl font-bold mb-3 text-secondary" 
            ...
            >
              ...
              <div className="px-3 py-2 h-full flex flex-col">
                {description && (
                  <p className="text-base text-main leading-relaxed line-clamp-10 triangle-text-wrap text-pretty flex-1">
                    {description}
                  </p>
                )}
                ...
                <div className="mt-auto pt-4">
                  <span className="text-main font-mono text-4xl font-bold">
