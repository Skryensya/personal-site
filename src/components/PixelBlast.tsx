...
const PixelBlast: React.FC<PixelBlastProps> = ({
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      // Create renderer & ensure transparency BEFORE append
      const canvas = document.createElement('canvas')
      ...
      // Canvas styling — be transparent from the very beginning
      ...
      // Keep transparency behavior consistent during updates
      if (transparent) {
        t.renderer.setClearColor(0x000000, 0)
        t.renderer.setClearAlpha(0)
        t.renderer.domElement.style.background = 'transparent'
      } else {
