...
export default function DitheredImageReact({
        ...
        const observer = new MutationObserver((mutations) => {
            mutations.forEach((mutation) => {
                if (
                    ...
                    (mutation.attributeName === 'data-theme' || mutation.attributeName === 'data-theme-id' || mutation.attributeName === 'class')
                ) {
    ...
    return (
        ...
        >
            ...
            {cachedImage && <img src={cachedImage} alt={alt} className={`block ${respectOriginalSize ? 'w-auto h-auto' : 'w-full h-full'}`} />}
