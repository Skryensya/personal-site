        ...
        return (
            <div className={`space-y-2 ${className}`}>
                ...
                <div className="flex gap-6 text-xs font-mono mb-4" style={{ color: 'color-mix(in srgb, var(--color-main) 70%, transparent)' }}>
                    ...
                    <div className="animate-pulse">
                        <span className="block w-12 h-3 mb-1" style={{ backgroundColor: 'color-mix(in srgb, var(--color-main) 30%, transparent)' }}></span>
      ...
      `}</style>
            ...
            <div className={`space-y-2 ${className}`}>
                ...
                {(() => {
                    ...
                    return (
                        <div
                            className="flex gap-6 text-xs font-mono mb-4"
